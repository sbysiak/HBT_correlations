...
def txt2rootGraph(configuration, rejection_lst=['002', '0025', '003']):
    """
    converts 2 text files into root TGraphAsymmErrors objects: atlas and therm graphs
    """
    ...
    for var,fig in zip(var_lst,fig_lst):
        ...
        therm_graph.SetName('therm'+centrality)
        therm_graph.Write() 
